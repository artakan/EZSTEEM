...
sudo -s git clone https://github.com/steemit/steem && cd steem && git checkout v0.13.0 && git submodule update --init --recursive && cmake -DCMAKE_BUILD_TYPE=Release -DLOW_MEMORY_NODE=OFF . && make
clear
